  ...
  operar = (boton) => {
    switch (boton) {
      ...
      default:
        if (boton !== "0") {
          if (
            this.state.resultado.length === 1 &&
            +this.state.resultado[0] === 0
          ) {
            this.setState({
              resultado: boton,
            });
      ...
      <div className="App">
        ...
        <p class="creditos">
          ...
          <span>
            ...
            on{" "}
            <a href="https://unsplash.com/s/photos/calculator-antique?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">
              Unsplash
            </a>
          </span>
        </p>
